...
class AdiantiTemplateTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['en'][] = 'Revendas';
        $this->messages['pt'][] = 'Revendas';
        $this->messages['es'][] = 'Revendas';

        $this->messages['en'][] = 'Fabricantes';
        $this->messages['pt'][] = 'Fabricantes';
        $this->messages['es'][] = 'Fabricantes';

        $this->messages['en'][] = 'Acessorios';
        $this->messages['pt'][] = 'Acessórios';
        $this->messages['es'][] = 'Acessorios';
